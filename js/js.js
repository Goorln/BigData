...
function func() {
  ...
  $.ajax({
    url: "http://662e5fb9a7dda1fa378cc879.mockapi.io/api/data/test",
    method: "GET",
    dataType: "json",
    ...
    success: function (res) {
      ...
      items = res
        ...
        .map(
          (item) =>
            `<li><p><span>${item.name}</span><span>90</span><span>两款手机</span></p></li>`
        )
        .join("");
...
$(function () {
    ...
    option = {
      ...
      series: [
        ...
        },
        {
          ...
          data: [120, 110, 125, 125, 122, 111, 98, 89, 78, 65, 55, 4],
        },
      ],
    };
  ...
  function echarts_4() {
    ...
    option = {
      ...
      legend: {
        data: [{ name: "当月审批" }, { name: "已执行" }, { name: "执行率" }],
        top: "0%",
        textStyle: {
      ...
      series: [
        ...
        },
        {
          name: "已执行",
          type: "bar",
          data: [4, 2, 34, 6, 8, 6, 4, 2, 28, 6, 8, 11],
          barWidth: "auto",
      ...
      series: [
        {
          ...
          barWidth: "15",
          data: [44, 45, 47, 51, 51, 56, 67, 77, 83, 86, 97, 99],
          z: 10,
        },
        {
          type: "bar",
